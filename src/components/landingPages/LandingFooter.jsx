...
import { companyDetails, logoImg, routes, routes2 } from "../../constant";
import {
  Facebook,
  Instagram,
  Linkedin,
      ...
      <div className="wrapper flex lg:flex-row flex-col gap-7 sm:gap-14 justify-between">
        <div className="">
          ...
          <p className="desc text-sm max-w-[22rem] mt-3">
            At Harzeno, we're dedicated to driving your business forward with
              ...
              <li>
                ...
                <li>
                  <Link
                    aria-label="Contact us on Phone"
                    to={`#`}
                    className="flex mt-3 gap-3 text-primary_text/70 hover:text-primary transition-colors duration-200"
                  >
                    <MapPin
                      strokeWidth={1.5}
                      size={20}
